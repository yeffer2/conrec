...
INSERT INTO CONREC.CFG_LISTA (ID,CODIGO,NOMBRE,DESCRIPCION,ESTADO,CREADOR,CREACION) values (4,'TIPO_DOI','Tipo de DOI','Tipo de documento de identidad','A',1,SYSDATE);
...
INSERT into CONREC.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) values (8,4,'L','DNI','DNI o libreta electoral',1,'A',1,SYSDATE);
INSERT into CONREC.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) values (9,4,'E','CE','Carné de extranjería',2,'A',1,SYSDATE);
INSERT into CONREC.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) values (10,4,'P','Pasaporte','Pasaporte',3,'A',1,SYSDATE);
INSERT into CONREC.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) values (11,4,'T','Carné policía','Carné de fuerzas policiales',4,'A',1,SYSDATE);
INSERT into CONREC.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) values (12,4,'D','Carné diplomático','Carné diplomático',5,'A',1,SYSDATE);
INSERT into CONREC.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) values (13,4,'R','RUC','RUC',6,'A',1,SYSDATE);
INSERT into CONREC.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) values (14,4,'U','RUS','RUS',7,'A',1,SYSDATE);
INSERT into CONREC.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) values (15,4,'J','Menor de edad','Menor de edad',8,'I',1,SYSDATE);
INSERT into CONREC.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) values (16,4,'MI','C.I.M.','Carné de identificación militar',9,'A',1,SYSDATE);
INSERT into CONREC.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) values (17,4,'N','RUC antiguo','RUC antiguo de 8 posiciones',10,'I',1,SYSDATE);
INSERT into CONREC.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) values (18,4,'O','Otras instituciones S/DOC','Otras instituciones S/DOC',11,'A',1,SYSDATE);
INSERT into CONREC.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) values (19,4,'W','SWIFT','SWIFT',12,'A',1,SYSDATE);
INSERT into CONREC.CFG_VALOR (ID,LISTA,CODIGO,NOMBRE,DESCRIPCION,ORDEN,ESTADO,CREADOR,CREACION) values (20,4,'S','Otros','Otros',13,'A',1,SYSDATE);
