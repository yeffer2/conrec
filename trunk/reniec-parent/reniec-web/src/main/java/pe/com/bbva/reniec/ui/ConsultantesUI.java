...
public class ConsultantesUI extends CustomComponent implements TextChangeListener,ClickListener{
	...
	public void postConstruct(){
		...
		txtNumero.setMaxLength(Constante.DOI_TIPO.LONGITUD.D.getValor());
		...
		cmbTipoDOI.addListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				...
				if(tipoDOI!=null){
					txtNumero.focus();
					int longitud=Constante.DOI_TIPO.LONGITUD.valueOf(tipoDOI.getCodigo()).getValor();
					...
					if(tipoDOI.getCodigo().equals(Constante.DOI_TIPO.CODIGO.DNI)){
	...
	public void buttonClick(ClickEvent event) {
		if(event.getButton().equals(btnGuardar)){
			...
			new BeanValidar[]{new BeanValidar("identificador", new Object[]{"REGISTRO/USUARIO"}, txtRegistro),
				...
				new BeanValidar("situacion", new Object[]{"ESTADO RENIEC"}, cmbEstadoReniec)});
	...
	public void textChange(TextChangeEvent event) {
		if(event.getSource().equals(txtNumero)){
			Valor tipoDOI=(Valor)cmbTipoDOI.getValue();
			if(tipoDOI!=null && tipoDOI.getCodigo().equals(Constante.DOI_TIPO.CODIGO.DNI)){
	...
	private HorizontalLayout buildPblTablaFiltro() {
		...
		txtRegistroFiltro.setSecret(false);
		...
		txtNombresFiltro.setSecret(false);
		...
		txtCodigoFiltro.setSecret(false);
		...
		txtNacionalidadFiltro.setSecret(false);
		...
		txtCentroFiltro.setSecret(false);
		...
		txtEstadoFiltro.setSecret(false);
		...
		txtAplicativoFiltro.setSecret(false);
